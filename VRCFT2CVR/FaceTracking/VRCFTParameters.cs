...
public static class VRCFTParameters
{
    ...
    internal static List<ICustomFaceExpression> CustomFaceExpressions = new();

    public static void UpdateParameters(List<CVRAnimatorManager.ParamDef> paramDef, ParameterVersion parameterVersion = ParameterVersion.Both)
    {
    ...
    private class VRCFTProgrammableExpression : ICustomFaceExpression
    {
        ...
        public bool IsMatch(string parameterName)
        {
            ...
            {
                match = parameterName == Name || Regex.IsMatch(parameterName);
